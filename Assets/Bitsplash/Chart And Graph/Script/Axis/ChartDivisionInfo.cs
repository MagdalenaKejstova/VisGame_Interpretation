...
namespace ChartAndGraph
{
    ...
    public class ChartDivisionInfo : IInternalSettings
    {
        ...
        /// <summary>
        /// Switch off gridlines but keep displaying axis values
        /// </summary>
        [SerializeField]
        [Canvas, NonCanvas]
        [Tooltip("Display guiding gridlines besides the main X and Y axes")]
        private bool drawDivisionLines = true;
        
        /// <summary>
        /// Switch off gridlines but keep displaying axis values
        /// </summary>
        public bool DrawDivisionLines
        {
            get {return drawDivisionLines;}
            set
            {
                drawDivisionLines = value;
                RaiseOnChanged();
            }
        }
        
        /// <summary>
        /// Switch off value labels
        /// </summary>
        [SerializeField]
        [Canvas, NonCanvas]
        [Tooltip("Display numbers next to labels")]
        private bool drawDivisionLabels = true;
        
        /// <summary>
        /// Switch off value labels
        /// </summary>
        public bool DrawDivisionLabels
        {
            get {return drawDivisionLabels;}
            set
            {
                drawDivisionLabels = value;
                RaiseOnChanged();
            }
        }
